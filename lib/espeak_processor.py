"""
Module: espeak_processor.py
Purpose: Post-processing for eSpeak TTS output. Handles audio format conversion specific to eSpeak engine.
...
Related: lib/tts/espeak.py, lib/audio.py
"""
...
def process_espeak_audio(wav_file, output_dir="output", base_name=None,
