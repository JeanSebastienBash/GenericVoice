"""
Test: test_007_009_espeak_import.py
Suite: 007 Tts
...
def test_espeak_tts_defined():
    assert ESpeakTTS is not None

def test_espeak_tts_is_class():
    assert isinstance(ESpeakTTS, type)

if __name__ == '__main__':
    test_espeak_tts_defined()
    test_espeak_tts_is_class()
    print("OK: test_007_009_espeak_import")
